 ...
 * @param {Object} email - Email field from the User Form.
 */
const validate = ({ name, email }, { t }) => {
    ...
    if (email && !re2.test(email)) errors.email = t('form-validation.email');
...
const enhance = compose(
    ...
    reduxForm({
        form: 'userForm',
        validate
        // Allow the form the reinitialize with new "pristine"
        // values every time the initialValues prop changes.
